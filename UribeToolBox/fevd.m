...
%function [fevdy,fevdx]=fevd(gx, hx, ETA, J)
% Computes the forecasting-error variance decomposition of y(t) and x(t)  at forecasting horizon J.
%  The (n_x by 1) vector x(t) and (n_y by 1) vector y(t) evolve according to
