...
% gx is ny by nx
% eta is nx by ne
% e is T by ne random shock (default~N(0,I)). Note that e(1) is not used in the simulation
%  because X(1) is taken as given.
...
%containing time series for x and y and e (T by ne) containing the innovations  
