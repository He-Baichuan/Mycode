...
ss = getssvalues(1.10991 , 0.24863, 0.298, 0.02293, 0.08532, τ_w, sp1_init,
                    mass_init, g_n_init, age_effciency, param)
#=                    
K = sol[1][1]
L = sol[1][2]
...
ga = ss.ga
V = ss.V
C_policy = ss.C_policy
A_policy = ss.A_policy
L_policy = ss.L_policy
gbar2015 = ss.ga
cgen = ss.cgen
lgen = ss.lgen
agen = ss.agen
...
p6 = plot(periods,lgen0)
p7 = plot(periods,lgeneps0)
